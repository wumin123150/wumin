package com.wumin.common.reflect;
...
public class ClassUtilTest {
	...
	public void getMessage() {
		...
		assertThat(ClassUtil.getPackageName(ClassUtilTest.class)).isEqualTo("com.wumin.common.reflect");
		assertThat(ClassUtil.getPackageName(BClass.class)).isEqualTo("com.wumin.common.reflect");
		assertThat(ClassUtil.getPackageName(ClassUtilTest.class.getName()))
				.isEqualTo("com.wumin.common.reflect");
		assertThat(ClassUtil.getPackageName(BClass.class.getName())).isEqualTo("com.wumin.common.reflect");
	...
	public void classPresent(){
		...
		assertThat(ClassUtil.isPresent("com.wumin.common.reflect.ClassUtil", ClassUtil.getDefaultClassLoader())).isTrue();
	}
