...
import com.wumin.common.base.ExceptionUtil.CloneableException;
import com.wumin.common.base.ExceptionUtil.CloneableRuntimeException;
import com.wumin.common.base.ExceptionUtil.UncheckedException;
...
public class ExceptionUtilTest {
	...
	public void staticException() {
		assertThat(ExceptionUtil.stackTraceText(TIMEOUT_EXCEPTION)).hasLineCount(2)
				...
				.contains("at com.wumin.common.base.ExceptionUtilTest.hello(Unknown Source)");

		assertThat(ExceptionUtil.stackTraceText(TIMEOUT_EXCEPTION2)).hasLineCount(2)
				.contains("com.wumin.common.base.ExceptionUtil$CloneableException: Timeout")
				.contains("at com.wumin.common.base.ExceptionUtilTest.hello(Unknown Source)");
		...
		assertThat(ExceptionUtil.stackTraceText(timeoutException)).hasLineCount(2)
				.contains("com.wumin.common.base.ExceptionUtil$CloneableException: Timeout for 30ms")
				.contains("at com.wumin.common.base.ExceptionUtilTest.hello(Unknown Source)");

		assertThat(ExceptionUtil.stackTraceText(TIMEOUT_EXCEPTION3)).hasLineCount(2)
				.contains("com.wumin.common.base.ExceptionUtil$CloneableRuntimeException: Timeout")
				.contains("at com.wumin.common.base.ExceptionUtilTest.hello(Unknown Source)");
		...
		assertThat(ExceptionUtil.stackTraceText(timeoutRuntimeException)).hasLineCount(2)
				.contains("com.wumin.common.base.ExceptionUtil$CloneableRuntimeException: Timeout for 40ms")
				.contains("at com.wumin.common.base.ExceptionUtilTest.hello(Unknown Source)");
